...
class CreateSolidQueueTables < ActiveRecord::Migration[8.1]
  def change
    create_table :solid_queue_jobs, if_not_exists: true do |t|
      ...
      t.index %i[queue_name finished_at], name: "index_solid_queue_jobs_for_filtering", if_not_exists: true
      t.index %i[scheduled_at finished_at], name: "index_solid_queue_jobs_for_alerting", if_not_exists: true
    end
    ...
    create_table :solid_queue_ready_executions, if_not_exists: true do |t|
      ...
      t.index %i[priority job_id], name: "index_solid_queue_poll_all", if_not_exists: true
      t.index %i[queue_name priority job_id], name: "index_solid_queue_poll_by_queue", if_not_exists: true
    end
    ...
    create_table :solid_queue_scheduled_executions, if_not_exists: true do |t|
      ...
      t.index %i[scheduled_at priority job_id], name: "index_solid_queue_dispatch_all", if_not_exists: true
    end
    ...
    create_table :solid_queue_semaphores, if_not_exists: true do |t|
      ...
      t.index %i[key value], name: "index_solid_queue_semaphores_on_key_and_value", if_not_exists: true
