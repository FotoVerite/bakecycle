Feature: Recipes Index
  ...
  Scenario: As a visitor, I should be able to view recipes index
  ...
  Scenario: As a visitor, I should be able to add an recipe
    When I go to the recipes page
  ...
  @javascript
  Scenario: As a visitor, I should be able to delete an recipe
  ...
  Scenario: As a visitor, I should be able to edit an recipe
    When I am on the edit page for "baguette" recipe
  ...
  @javascript
  Scenario: As a visitor, I should get an error if I try to add an empty recipe item to a recipe
    When I am on the edit page for "baguette" recipe
  ...
  @javascript
  Scenario: As a visitor, I should be able to add recipe items to an existing recipe
    When I am on the edit page for "baguette" recipe
    When I click on "Add Ingredient"
  ...
  @javascript
  Scenario: As a visitor, I should be able to add a recipe with multiple items
    When I go to the recipes page
    And I click on "Add New Recipe"
    And I fill out recipe form with:
      | name | mix_size | mix_size_unit| lead_days | recipe_type | note                 |
  ...
  @javascript
  Scenario: As a visitor, I should be able to edit a recipe and delete another recipe
    When I go to the recipes page
    And I click on "Add New Recipe"
    And I fill out recipe form with:
      | name | mix_size | mix_size_unit| lead_days | recipe_type  | note                 |
